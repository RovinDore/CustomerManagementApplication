...
public class StorageImplementation implements StorageService {
    ...
    @Autowired
    public StorageImplementation(StorageProperties properties) {
    ...
    @Override
    @Transactional
    public Path storeGetDestination(MultipartFile file) {
        try {
            if (file.isEmpty()) throw new StorageException("Failed to store empty file.");
            String fileType = file.getContentType();
            if(!Objects.equals(fileType, "application/pdf") && !Objects.equals(fileType, "image/jpeg")) throw new StorageException("Wrong file type");
