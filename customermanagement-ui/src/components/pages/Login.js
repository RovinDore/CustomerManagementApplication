...
export default function Login(props) {
    ...
    const handleSubmit = (e) => {
        ...
        // send login request
        apiReq.post('/auth/login', loginCredentials).then(access => {
            console.log({ access });
            setStatusMsg({ show: false });
                        ...
                        <CardContent>
                            <Box component="form" autoComplete="off" onSubmit={handleSubmit}>
                                <Grid container spacing={2} rowSpacing={2}>
                                    ...
                                    <Grid item xs={12}>
                                        <LoadingButton loading={isSubmitting} variant="contained" type={'submit'} startIcon={<LoginIcon />}>Login</LoadingButton>
                                    </Grid>
                                    <Grid item xs={12}>
