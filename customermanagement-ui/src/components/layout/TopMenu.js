...
export default function TopMenu(props) {
    ...
    let menuItems = [
        { text: 'Customers', icon: <FormatListBulletedIcon style={{color: '#fff'}} />, link: '/' },
        // { text: 'Dependants', icon: <DescriptionIcon style={{color: '#fff'}} />, link: 'Dependants' },
        { text: 'Profile', icon: <PersonIcon style={{color: '#fff'}} />, link: '/profile' },
    ...
    return (
        <Grid container spacing={2} columnSpacing={2} sx={{padding: '15px 50px', backgroundColor: '#0c5093'}}>
            <Grid item xs={6} textAlign='left'>
                <NavLink to={'/'} style={{textDecoration: 'none'}}><Typography sx={{ minWidth: 100 }} variant='h4' color={'#fff'}>Customer Management</Typography></NavLink>
            </Grid>
